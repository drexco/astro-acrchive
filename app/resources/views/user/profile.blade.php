...
<html lang="en">
    ...
    <head>
        ...
        <title>Astro Options : Profile</title>
                    ...
                    <ul class="navigation-left">
                        @if(Session::get('user_id'))
                             @if(Session::get('account_type')=='user')
                                ...
                                <li class="nav-item active" data-item="profile">
                                    <a class="nav-item-hold" href="#">
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                {{ Form::open(array('url' => '/users/profile/edit/'.$data->id, 'method'=>'post','autocomplete' => 'off', 'role'=>'form')) }}
                                    {{ csrf_field() }}
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">@</span>
                                        </div>
                                        {{ Form::text('username',$data->username,array('placeholder'=>'Username','class'=>'form-control','id'=>'username','name'=>'username')) }}
                                    </div>
                                    <div>&nbsp;</div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="basic-url">Select Language</label>
                                            <div class="input-group mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-4">
                                                <p class="text-primary mb-1"><i class="i-Status text-16 mr-1"></i>{{$data->status}}</p>
                                        </div>
                                        </div>
                                    </div>
                                    <div>&nbsp;</div>
                                    <div class="input-group">
                                        <button class="btn btn-lg btn-primary ladda-button basic-ladda-button" data-style="expand-right"><span class="ladda-label">Edit</span></button>
                                    </div>
                                {{Form::close()}}
                                <div class="row">
                                    <div class="col-md-9">
