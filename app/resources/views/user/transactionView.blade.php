...
<html lang="en">
    ...
    <head>
        ...
        <title>Astro Options : Tranasctions</title>
                    ...
                    <ul class="navigation-left">
                        @if(Session::get('user_id'))
                             @if(Session::get('account_type')=='user')
                                ...
                                <li class="nav-item active" data-item="transactions">
                                    <a class="nav-item-hold" href="#">
                    ...
                    @if(Session::get('user_id'))
                             @if(Session::get('account_type')=='user')
                                ...
                                <ul class="childNav" data-parent="transactions">
                                    <li class="nav-item">
                                        <a href="../../users/transactions/list">
            ...
            <div class="separator-breadcrumb border-top"></div>
                    <!-- Main Content I -->
						...
						<div class="panel-heading">
							<h3 class="panel-title panel-default">Ref# :{{$data->ref_code}}</h3>
						</div>
						<div class="panel-body">
							<table class="table table-user-information">
								<tbody>
									...
									<tr>
										<td>Charges:</td>
										<td>${{number_format($data->charges, 2)}}</td>
									</tr>
									<tr>
										<td>Initiated On:</td>
										<td>{{date('d M Y  h:i a',strtotime($data->initiated_on))}}</td>
									</tr>
		                                                        <tr>
										<td>Completed On:</td>
										<td>{{date('d M Y  h:i a',strtotime($data->completed_on))}}</td>
									</tr>
		                                                         <tr>
										<td>Status:</td>
										<td>{{$data->status}}</td>
