                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{$data['balance']->account_balance}}" disabled="disabled">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{$data['trading']->account_balance}}" disabled="disabled">
                                    <div class="input-group-append">
                                        <span class="input-group-text">.00</span>
                                    </div>
                                </div>
