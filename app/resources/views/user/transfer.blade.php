            ...
            <div class="separator-breadcrumb border-top"></div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            {{ Form::open(array('class'=>'needs-validation', 'url' => '/users/transferfunds/transfer', 'method'=>'post','autocomplete' => 'off', 'role'=>'form', 'novalidate'=>'novalidate')) }}
                            {{ csrf_field() }}
                            <div class="input-group mb-3">                                    
                        ...
                        {{Form::close()}}
                            <div class="col-md-6">
                                <div class="input-group mb-3">   
                                    @if(Session::get('transferfunds_message'))
                                        {{Session::get('transferfunds_message')}}
                                    @endif
                                </div>                                    
                            </div>
